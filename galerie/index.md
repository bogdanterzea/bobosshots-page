# Galerii — Bobosshots Portfolio

> Markdown companion for https://bobosshots.com/galerie. The HTML version is the canonical browseable gallery.
...
- Portfolio thumbnails are served from `/portfolio/<category>/thumbs/` as WebP + JPEG.
- Larger format images are available from `/portfolio-backup/<category>/`.
- Image sitemap is published at https://bobosshots.com/sitemap.xml.
